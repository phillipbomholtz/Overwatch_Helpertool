...
public class PlayerScheduleMenuSunday extends javax.swing.JPanel {
    ...
    public List<TimeStretch> GiveTimeStreches(){
        ...
        //for first stretch
        if(stretchOneSundaySelect.isSelected()){
            //get hours an minuts of start
            String startTime=getValueString(TimeSpinSunday1.getValue().toString());
            ...
            String endTime = getValueString(TimeSpinSunday2.getValue().toString());
        ...
        //for seconds stretch
        if(stretchTwoSundaySelect.isSelected()){
            //get hours an minuts of start
            String startTime=getValueString(TimeSpinSunday3.getValue().toString());
            StringTokenizer startReader = new StringTokenizer(startTime,"(:)");
            int startHour = Integer.parseInt(startReader.nextToken());
            int startMminut = Integer.parseInt(startReader.nextToken());
            ...
            //get hours an minuts of end
            String endTime = getValueString(TimeSpinSunday4.getValue().toString());
            StringTokenizer endReader = new StringTokenizer(endTime,"(:)");
            int endHour = Integer.parseInt(endReader.nextToken());
            int endMinute = Integer.parseInt(endReader.nextToken());
        ...
        //for third stretch
        if(stretchThreeSundaySelect.isSelected()){
            //get hours an minuts of start
            String startTime=getValueString(TimeSpinSunday5.getValue().toString());
            StringTokenizer startReader = new StringTokenizer(startTime,"(:)");
            int startHour = Integer.parseInt(startReader.nextToken());
            int startMminut = Integer.parseInt(startReader.nextToken());
            ...
            //get hours an minuts of end
            String endTime = getValueString(TimeSpinSunday6.getValue().toString());
            StringTokenizer endReader = new StringTokenizer(endTime,"(:)");
            int endHour = Integer.parseInt(endReader.nextToken());
            int endMinute = Integer.parseInt(endReader.nextToken());
        ...
        //for fourth stretch
        if(stretchFourSundaySelect.isSelected()){
            //get hours an minuts of start
            String startTime=getValueString(TimeSpinSunday7.getValue().toString());
            StringTokenizer startReader = new StringTokenizer(startTime,"(:)");
            int startHour = Integer.parseInt(startReader.nextToken());
            int startMminut = Integer.parseInt(startReader.nextToken());
            ...
            //get hours an minuts of end
            String endTime = getValueString(TimeSpinSunday8.getValue().toString());
            StringTokenizer endReader = new StringTokenizer(endTime,"(:)");
            int endHour = Integer.parseInt(endReader.nextToken());
            int endMinute = Integer.parseInt(endReader.nextToken());
